...
from useful_functions import calculate_rsi, create_attention_layer
...
# data = web.DataReader(company, start=start, end=end, data_source=data_source)
...
lstm = LSTM(units=50, return_sequences=False)(attention)
